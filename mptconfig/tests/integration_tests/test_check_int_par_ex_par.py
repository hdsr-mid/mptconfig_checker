...
def test_check_int_par_ex_par_1(patched_path_constants_1):
    """integration test with patched paths 1"""
    meetpunt_config = MptConfigChecker()
    excelsheet = meetpunt_config.check_int_par_ex_par(sheet_name="blabla")
...
def test_check_int_par_ex_par_2(patched_path_constants_2):
