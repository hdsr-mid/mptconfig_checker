from mptconfig.constants import _mswlocationset
...
def test_mswlocationset_1(patched_path_constants_1):
    assert _mswlocationset.idmap_section_name == expected_idmap_section_name_1_and_2
    assert _mswlocationset.name == expected_name_1_and_2
    assert _mswlocationset.csv_filename == expected_csvfile_1_and_2
    assert _mswlocationset.fews_name == expected_fews_name_1_and_2
    assert _mswlocationset.get_validation_attributes(int_pars=None) == expected_validation_attributes_1_and_2
    assert _mswlocationset.validation_rules == expected_validation_rules_1_and_2
    assert _mswlocationset.csv_file_meta == expected_csvfile_meta_1_and_2
    assert _mswlocationset.attrib_files == expected_attrib_files_1_and_2
